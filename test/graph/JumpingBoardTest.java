...
public class JumpingBoardTest {
  JumpingBoard jumpingboard = new JumpingBoard();

  @Test
  public void case1() {
    String[] board = { "3942178", "1234567", "9123532" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case2() {
    String[] board = { "2H3HH4HHH5" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case3() {
    String[] board = { "3994", "9999", "9999", "2924" };
    assertEquals(-1, jumpingboard.maxJumps(board));
  }
  ...
  @Test
  public void case35() {
    String[] board = { "9H3333HHHHHHHHHHHHH" };
    assertEquals(1, jumpingboard.maxJumps(board));
  }
  ...
  @Test
  public void case39() {
    String[] board = { "3HH5HHHHHHHHHH", "HHHHHHHHHHHHHH", "HHHHHHHHHHHHHH", "5HH4H2H8HHHHHH", "HHHHHHHHHHHHHH", "HHH2HHHHHHHHHH" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }
  ...
  @Test
  public void case43() {
    String[] board = { "2939", "9999", "1999", "2949" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }
  ...
  @Test
  public void case81() {
    String[] board = { "12H4", "9HHH", "1HHH", "HHHH", "2HH3" };
    assertEquals(7, jumpingboard.maxJumps(board));
  }

  @Test
  public void case82() {
    String[] board = { "2H5", "HHH", "4HH", "HHH", "HHH", "HHH", "2H6" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case83() {
    String[] board = { "3HH2", "HHHH", "HHH1", "2H19" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case84() {
    String[] board = { "3HH9", "HHHH", "HHH2", "12H1" };
    assertEquals(6, jumpingboard.maxJumps(board));
  }

  @Test
  public void case85() {
    String[] board = { "4HHH7", "HHHHH", "HHHHH", "HHHHH", "1HHHH", "4HHH5" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }
  ...
  @Test
  public void case87() {
    String[] board = { "12H12H12H12H12H12H12H12H12H12H12H12H12H" };
    assertEquals(26, jumpingboard.maxJumps(board));
  }

  @Test
  public void case88() {
    String[] board = { "2H4", "HHH", "1HH", "2H1", "HH2" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case89() {
    String[] board = { "2H12", "HHHH", "3HH9" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case90() {
    String[] board = { "2H31", "HHHH", "3HH2", "HH1H" };
    assertEquals(6, jumpingboard.maxJumps(board));
  }

  @Test
  public void case91() {
    String[] board = { "2H91", "HHHH", "3HH2" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case92() {
    String[] board = { "251", "HHH", "12H" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case93() {
    String[] board = { "2H12", "HHHH", "3HH5" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case94() {
    String[] board = { "2HHH", "HHHH", "3HH1", "HHHH", "HHHH", "1HHH", "3HH1", "HHH5" };
    assertEquals(7, jumpingboard.maxJumps(board));
  }

  @Test
  public void case95() {
    String[] board = { "19H2", "3HH1" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case96() {
    String[] board = { "2H1", "1H2" };
    assertEquals(-1, jumpingboard.maxJumps(board));
  }

  @Test
  public void case97() {
    String[] board = { "12H3", "HHHH", "HHHH", "H3H2" };
    assertEquals(-1, jumpingboard.maxJumps(board));
  }

  @Test
  public void case98() {
    String[] board = { "3HH4", "HHH1", "HHHH", "2H12" };
    assertEquals(6, jumpingboard.maxJumps(board));
  }

  @Test
  public void case99() {
    String[] board = { "3HH2", "HHHH", "HHH1", "2H14" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case100() {
    String[] board = { "13", "2H", "HH", "91" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case101() {
    String[] board = { "2H3H", "HHHH", "3HH1", "HH15" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case102() {
    String[] board = { "3919", "9999", "9999", "2939" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case103() {
    String[] board = { "3992", "3999", "9991", "291H" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case104() {
    String[] board = { "12", "HH", "21" };
    assertEquals(-1, jumpingboard.maxJumps(board));
  }

  @Test
  public void case105() {
    String[] board = { "2H3H", "HHHH", "3HH1", "HH14" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case106() {
    String[] board = { "39919", "99999", "99999", "49993" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case107() {
    String[] board = { "2H12", "HHHH", "12H1" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case108() {
    String[] board = { "12H9", "3HH1" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case109() {
    String[] board = { "12", "2H", "H1", "12" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case110() {
    String[] board = { "2H1HH", "HH9H2", "4HHH1" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case111() {
    String[] board = { "3HH4", "HHHH", "HHHH", "9HHH", "1HH3" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case112() {
    String[] board = { "599991", "199392" };
    assertEquals(-1, jumpingboard.maxJumps(board));
  }

  @Test
  public void case113() {
    String[] board = { "3HH2H3", "HHHHHH", "HHHHHH", "2H3HH1" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }
  ...
  @Test
  public void case117() {
    String[] board = { "6HHHHH2HHH", "HHHHHHHHHH", "HHHHHH6HHH", "HHHHHHHHHH", "HHHHHHHHHH", "HHHHHHHHHH", "2HHHHHHHHH", "HHHHHHHHHH", "3HH1HH3HHH" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case118() {
    String[] board = { "3992", "3999", "9991", "2919" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case119() {
    String[] board = { "273772", "777777", "377271" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }

  @Test
  public void case120() {
    String[] board = { "13HH", "3HH2", "HHHH", "H2H9" };
    assertEquals(4, jumpingboard.maxJumps(board));
  }

  @Test
  public void case121() {
    String[] board = { "14HHH9", "2H3HH1" };
    assertEquals(5, jumpingboard.maxJumps(board));
  }
