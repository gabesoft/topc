...
public class GrafixMaskTest {
  GrafixMask _calc = new GrafixMask();

  @Test 
  public void case1() {
    String[] data = { "0 292 399 307" };
    int[] expected = { 116800, 116800 };
    assertArrayEquals(expected, _calc.sortedAreas(data));
  }
  ...
  @Test 
  public void case3() {
    String[] data = { "0 192 399 207", "0 392 399 407", "120 0 135 599", "260 0 275 599" };
  ...
  @Test 
  public void case4() {
    String[] data = { "50 300 199 300", "201 300 350 300", "200 50 200 299", "200 301 200 550" };
  ...
  public void case5() {
    ...
    int[] expected = { 
      15,  30,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  45,  
      45,  45,  45,  45,  45,  100,  115,  115,  115,  115,  115,  115,  115,  115,  115,  115,  115,  115,  
      115,  115,  115,  115,  115,  115,  115,  115,  115,  115,  115,  115,  200,  230,  230,  230,  230,  
      230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  230,  
      230,  230,  230,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  
      300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  345,  345,  345,  345,  345,  345,  345,  
