...
public class TimeTravellingSalesmanTest {
  TimeTravellingSalesman timetravellingsalesman = new TimeTravellingSalesman();

  @Test
  public void case1() {
    int N = 3;
    String[] roads = { "0,1,1 0,2,1 1,2,2" };
    assertEquals(2L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case2() {
    ...
    assertEquals(14L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case3() {
    int N = 3;
    String[] roads = { "0,2,2" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case23() {
    int N = 5;
    String[] roads = { "2,3,", "2 0,4,7", " 1,4", ",8 3,4,", "2 0,1,", "5 0,3,", "4 ", "2,4", ",5", " 1,3", ",8 1,2,", "6 0,2,9" };
    assertEquals(13L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case24() {
    int N = 5;
    String[] roads = { "3", ",4,1 0,", "1", ",5 1", ",4,3", " 0,3", ",1", " 1", ",2,2", " 2", ",3", ",2 0", ",4,", "6 2,4", ",7 1", ",3,", "2 ", "0,2,5" };
    assertEquals(6L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case25() {
    int N = 5;
    String[] roads = { "1,", "3,", "1 ", "0", ",4,", "4", " ", "2,", "4", ",6", " 3", ",4", ",3 ", "0", ",", "2,3", " ", "0,", "3,", "1 2", ",3", ",3", " ", "0,", "1,7", " ", "1", ",4,8", " ", "1,", "2", ",4" };
    assertEquals(8L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case27() {
    int N = 2;
    String[] roads = { "0,1,7" };
    assertEquals(7L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case28() {
    int N = 3;
    String[] roads = { "1,", "2", ",", "7", " ", "0", ",", "2,9" };
    assertEquals(16L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case29() {
    int N = 5;
    String[] roads = { "1", ",", "3", ",", "6", " ", "1", ",", "2", ",", "5" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case38() {
    int N = 3;
    String[] roads = { "0,", "2,6", " ", "1", ",", "2,", "4", " ", "0", ",", "1,7" };
    assertEquals(10L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case39() {
    int N = 5;
    String[] roads = { "2", ",", "3", ",", "9", " ", "1", ",", "3", ",", "2 0", ",", "1", ",", "6", " ", "2,", "4", ",", "3", " ", "0", ",", "3", ",", "5", " ", "0", ",", "4", ",", "3", " ", "1", ",", "2,", "4", " ", "1", ",", "4", ",", "1" };
    assertEquals(9L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case40() {
    int N = 10;
    String[] roads = { "1,2,7 3,7,1 2,4,2 5,9,9 0,8,5 0,6,1 5,6,4 1,8,1" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case41() {
    int N = 25;
    String[] roads = { "5", ",", "1", "5", ",", "3", " ", "2", "1", ",", "2", "4", ",", "9", " ", "1", "4", ",", "2", "4", ",", "3", " ", "4", ",", "1", "0", ",", "1", " ", "6", ",", "8", ",", "5", " ", "1", "1", ",", "1", "6", ",", "9" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case42() {
    int N = 150;
    String[] roads = { "7", "3", ",1", "0", "3", ",", "8", " ", "3", "9", ",", "1", "0", "1", ",", "1", " ", "7", "2", ",1", "4", "1", ",", "7 ", "1", "0", "9", ",", "1", "2", "3", ",", "9", " ", "7", "2,", "1", "37", ",", "4" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case43() {
    int N = 200;
    String[] roads = { "1", "0,", "7", "4", ",", "6", " 9,", "1", "1", "3", ",", "8", " ", "5", "5,", "75", ",", "3 ", "1", "6", "4,", "1", "9", "6", ",1", " 8", ",", "1", "4", "0", ",", "2", " ", "7", ",1", "3", "7,", "5" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case44() {
    int N = 300;
    String[] roads = { "2", "3", "1,", "27", "7,", "5 ", "59", ",", "2", "1", "6,", "7 ", "5", "6", ",", "2", "7", "7", ",8 ", "250", ",", "29", "5,1", " ", "14", "3,", "1", "4", "8", ",", "6" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case45() {
    int N = 400;
    String[] roads = { "1", "4", "8", ",", "1", "66", ",2", " 2", "51,", "27", "7", ",", "7", " ", "230", ",", "3", "7", "9", ",", "1", " ", "2", "4", "7", ",", "3", "9", "9", ",", "8 ", "28", ",1", "2", "4", ",", "8" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case46() {
    int N = 1000;
    String[] roads = { "7", "2", "8", ",9", "5", "4", ",", "9 ", "4", "3", "8", ",", "8", "28", ",", "3", " ", "4", "9", "7,", "8", "90", ",", "6", " ", "81,", "4", "3", "3,", "7", " 5", "75", ",", "9", "94", ",4" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case48() {
    int N = 3;
    String[] roads = { "1,2,8 0,1,", "2 0,2,1" };
    assertEquals(3L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case49() {
    int N = 5;
    String[] roads = { "0,", "3,9", " 0", ",1", ",2", " 1,", "4", ",", "8 ", "2", ",4,4", " 3,", "4,", "7", " 1,", "3,4", " 1", ",2", ",8", " 2,", "3,4", " 0,2,", "1 ", "0,4", ",7" };
    assertEquals(11L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case50() {
    int N = 10;
    String[] roads = { "3,5,7", " 8,", "9,4 0,", "4,3 3,", "7,3 1,", "2,", "3 1,3,7", " 5,6,3 0,", "5,4 1,", "9,4", " 0,1,", "9 3,8,8 7", ",8,6 2,", "5,9 1,6,5", " 2,6,8 4,", "9,1 7,9,2", " 0,8,7 4,", "8,2 5,", "9,4 ", "1,5,8 ", "6,8,", "1 0,6", ",4 2,4,", "3 2,8,", "6 6,9,7", " 4,6,9 2,9", ",3 1,7,4", " 5,7,5", " 1,8,", "1 4,7", ",2 3", ",4,5 ", "5,8,9 ", "1,4,", "7 4,", "5,4 0,9", ",1 3,", "6,2 3,9,", "3 2,", "3,3 ", "0,3,3 2,7,4", " 6,7,4", " 0,7,4 ", "0,2,3" };
    assertEquals(16L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case57() {
    int N = 2;
    String[] roads = { "0", ",1,5" };
    assertEquals(5L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case58() {
    int N = 3;
    String[] roads = { "0", ",", "2", ",", "1", " ", "1", ",", "2", ",9", " 0", ",", "1", ",", "3" };
    assertEquals(4L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case59() {
    int N = 5;
    String[] roads = { "3,", "4,5", " ", "1,", "4", ",3", " 0", ",1,6", " 2,", "3,6", " 2,4", ",4 ", "0,2", ",9 0", ",4,", "1 1", ",", "2", ",7 ", "0,3", ",1 ", "1", ",3", ",7" };
    assertEquals(9L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case67() {
    int N = 2;
    String[] roads = { "0,1,415", "6053" };
    assertEquals(4156053L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case68() {
    int N = 3;
    String[] roads = { "0", ",1", ",", "3", "434", "72", "2" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case72() {
    int N = 150;
    String[] roads = { "117", ",1", "3", "8", ",", "116", "05", "1", "7" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case73() {
    int N = 200;
    String[] roads = { "1", "5", "5,", "1", "6", "9", ",", "51", "3", "1", "8", "2", "4" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case74() {
    int N = 300;
    String[] roads = { "2", "1,", "2", "5", "8", ",", "5", "6", "5", "5", "4", "02" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case75() {
    int N = 400;
    String[] roads = { "126,", "2", "2", "3,", "739", "237", "8" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case76() {
    int N = 1000;
    String[] roads = { "22", "6,56", "2,3", "4130", "51" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case77() {
    int N = 2;
    String[] roads = { "0,1,7042786" };
    assertEquals(7042786L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case78() {
    int N = 3;
    String[] roads = { "1,2", ",1", "3", "615", "94 0,2", ",789", "906", "0 0,", "1,7", "753", "665" };
    assertEquals(9115259L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case79() {
    int N = 5;
    String[] roads = { "1,4,5", "991", "448", " 0,4,6", "2", "5", "7049", " ", "0,", "2,7", "70", "58", "54 3,", "4", ",5", "44", "804", "2" };
    assertEquals(25402393L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case80() {
    int N = 10;
    String[] roads = { "7,", "9", ",6", "4", "9", "6", "8", "1", "1", " ", "1", ",", "9", ",", "9", "7", "1", "4", "4", "3", "3 ", "0", ",", "3", ",", "4", "0", "3", "2", "4", "6", "0", " ", "3", ",", "6", ",", "9", "0", "0", "4", "6", "5", "1" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case81() {
    int N = 25;
    String[] roads = { "9", ",", "21", ",9", "10", "9", "3", "7", "9", " 1", "2", ",", "1", "8", ",", "8", "6", "8", "4", "9", "0", "9", " ", "2", ",", "7", ",", "5", "0", "7", "0", "2", "1", "8" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case82() {
    int N = 150;
    String[] roads = { "9", "1", ",", "1", "0", "2", ",", "2", "74", "1", "662", " ", "102,", "1", "1", "8", ",", "9", "056", "4", "7", "0", " ", "5", "1", ",", "1", "0", "1,", "43", "67", "39", "2" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case83() {
    int N = 200;
    String[] roads = { "4", ",", "1", "49,", "4", "9", "64", "6", "0", "3", " ", "10", "7", ",", "1", "1", "1,9", "9", "2", "9", "8", "8", "8", " ", "1", "46", ",", "19", "5", ",", "9", "54", "5", "5", "6", "0" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case84() {
    int N = 300;
    String[] roads = { "6", "4", ",", "9", "2", ",", "9", "2", "8", "7", "3", "5", "0", " ", "2", "8", ",", "1", "7", "8", ",", "8", "9", "8", "3", "2", "5", " ", "1", "3", "3", ",", "2", "5", "1", ",", "7", "7", "1", "9", "7", "0", "6" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case85() {
    int N = 400;
    String[] roads = { "1", "3", "5", ",", "1", "8", "0,2", "39", "3", "4", "8", "2 ", "1", "5", "7,", "2", "5", "2", ",", "14", "9", "51", "5", "7", " ", "1", "8", "3,", "2", "66", ",", "2", "6", "8", "0", "0", "88" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case86() {
    int N = 1000;
    String[] roads = { "233,50", "1,6", "84", "2242 ", "10,2", "69,68", "09", "569 40,", "589,7", "464414" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case87() {
    int N = 2;
    String[] roads = { "0", ",1", ",", "5", "9", "9", "7", "7", "3", "4" };
    assertEquals(5997734L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case88() {
    int N = 3;
    String[] roads = { "0", ",1", ",", "9", "2", "9", "28", "8", "0", " 0", ",", "2", ",", "4", "81", "9", "4", "8", "7", " 1", ",", "2", ",", "6", "3", "8", "2", "0", "0" };
    assertEquals(5457687L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case89() {
    int N = 5;
    String[] roads = { "2,3,4", "751", "199", " 0,", "1,308", "4", "92", "2 1", ",", "4,18", "95", "684", " ", "0,4,", "265", "23", "8", "8 0", ",3", ",7", "0813", "83 0", ",2", ",", "28", "00503", " 1,3", ",541", "9188 ", "3,4,9", "28", "3620", " 1", ",2", ",48", "654", "05", " 2,4", ",", "473", "16", "73" };
    assertEquals(12099774L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case116() {
    int N = 5;
    String[] roads = { "0,1,1", "00000", "00 0,2", ",10000", "000 ", "0,3,1", "0000000", " 0,4,10", "000000" };
    assertEquals(40000000L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case117() {
    int N = 5;
    String[] roads = { "0,", "3,1000", "0000", " 2,", "3,1", "00000", "00 ", "2,4", ",1000", "00", "00 ", "0,1", ",1", "00000", "00 ", "1,2,10", "000000", " 3,4", ",10000", "000 0,", "4,10", "000", "000 1,3,", "100000", "00 1,4,10", "000", "000 0,2,1", "0000000" };
    assertEquals(40000000L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case123() {
    int N = 4;
    String[] roads = { "0", ",2", ",", "1", " ", "0", ",1", ",", "1", " ", "2", ",3", ",", "1" };
    assertEquals(3L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case166() {
    int N = 42;
    String[] roads = { "25,41,9794498 12,41,9478466 13,22,931459", "2 31,39,9658670 2,5,9834324 22", ",40,9083310 12,21,9419903 0,20,98067", "87 10,20,9330815 21,32,9544519 8,23,", "9353711 16,38,9439773 8,30,9839687", " 1,29,9226790 8,25,9484329 1,", "33,9993938 16,27,9592761 30,34,9971240 18,", "24,9461021 3,21,9829530 4,6,9979", "564 6,26,9759339 16,26,904", "7915 7,27,9871620 7,15,9920502 4,36,9", "007298 6,10,963924", "3 17,39,9097612 28,35,9822543 7,3", "7,9655943 4,5,9145174 14,31,9635047 9,10,92503", "66 18,22,9974538 20,28", ",9134065 11,30,9922487 13,36,94789", "51 13,33,9029936 20,31,94862", "49 6,23,9070706 19,40,9668046" };
    assertEquals(391055808L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case167() {
    int N = 10;
    String[] roads = { "7,9,9134121 0,", "8,9987867 5,8,9", "038581 5,7,906", "4715 4,8,9395219 ", "1,7,9574752 3,4,945", "6988 2,8,99699", "05 5,9,92779", "95 4,9,9504449 6,", "8,9503997 7,8,", "9800823 4,6,9329", "704 0,4,92520", "50 1,4,9183975 3,9,9", "833738 2,7,9687825 ", "0,1,9930100 6,", "9,9268042 3,5,9", "686910 0,2,956", "4213 3,7,9716113 2,3", ",9878423 0,7,9024", "930 2,4,9831855 1,", "5,9530248 0,5,9092", "924 1,2,987", "2781 1,9,970360", "0 8,9,9717321 0,3,", "9777681 1,8,96", "65682 2,6,", "9195003 4,5,", "9567814 1,6,905", "4824 3,8,9979613", " 3,6,9042648 0,9,9", "050013 1,3,99", "79128 2,5,9461590", " 4,7,9648975 0,6", ",9018328 6,7,", "9312219 5,6,9137", "704 2,9,9935356" };
    assertEquals(81673017L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case168() {
    int N = 2;
    String[] roads = { "0,1,975", "5908" };
    assertEquals(9755908L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case169() {
    int N = 2;
    String[] roads = { "0", ",", "1", ",", "5", "5", "6", "9", "0", "1", "9" };
    assertEquals(5569019L, timetravellingsalesman.determineCost(N, roads));
  }

  @Test
  public void case170() {
    int N = 10;
    String[] roads = { "3,6", ",30", "31", "05", "8", " ", "1", ",8,8", "2", "72", "8", "20", " 2,7", ",", "45", "9857", "1", " 3,4,", "8038", "39", "4", " 5,", "8,", "3", "870", "809 ", "6,", "7,", "30", "813", "1", "8", " 7", ",9", ",433", "83", "9", "7 ", "0", ",1,", "3", "9", "66", "7", "99" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case173() {
    int N = 10;
    String[] roads = { "1,", "7,", "25", "32", "791", " ", "2,9", ",30", "7", "3", "361 ", "0", ",8", ",", "3", "85", "50", "11 ", "3", ",5", ",", "2", "719", "4", "6", "8 ", "1", ",2,3", "843", "4", "23", " 6", ",8,", "28", "542", "62 ", "4", ",5", ",2", "6", "09", "1", "49" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case176() {
    int N = 10;
    String[] roads = { "1", ",3", ",", "2", "04", "24", "3", "6 4", ",", "8", ",", "2", "6", "5", "6", "5", "40", " ", "2,4", ",", "13", "0", "4", "12", "7", " ", "6,", "8,", "20", "5", "7", "39", "8", " ", "0,", "7,", "239", "9", "0", "2", "2" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case179() {
    int N = 100;
    String[] roads = { "13,90,2177759 2,42,4649120 27", ",48,5275001 52,54,33", "58500 33,95,5979316 35,76,57086", "32 33,85,5914556 ", "50,84,2931223 45,69,42", "13149 14,96,3711371 11,", "24,5511887 18,49,5006548 45", ",99,3220707 4", ",15,2205638 23,50,236371", "9 44,65,1849408 1,9,487473", "6 38,55,4473460 30,", "73,2925555 22,39,1", "834477 40,71,3185002 5,12,", "5983955 19,32,2991211 ", "10,66,4608568 31,91,5893", "458 25,74,2610735 24,6", "0,5455359 38,70,4394094 4", "1,89,4654939 44,94,248", "8543 43,63,3363461 27,56,20", "95097 20,63,2967977", " 14,68,2534332 3,73,2", "944297 21,28,4877852 3", "7,99,5886466 51,78,5048577", " 88,97,3227114 54,81,32745", "24 9,49,4838562 16,79", ",3670041 29,75,3980200 ", "17,21,2674238 7,71,59", "17984 53,92,20269", "70 80,87,5182826 69,98,296", "2723 74,77,2949347 58,8", "4,2514403 14,46,3324493 8,39", ",1806100 2,80,4679970", " 19,26,5880888 64,67", ",1955176 93,98,314680", "0 6,74,2923707 31,6", "1,2927399 0,52,5338", "874 28,97,5248951" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case181() {
    int N = 100;
    String[] roads = { "2", "4", ",8", "1", ",", "5", "9", "7", "553", "3", " 7", "3", ",", "7", "8", ",5", "3", "3", "80", "1", "7", " 1", "4", ",", "1", "9", ",", "4", "6", "2", "0", "60", "0" };
    assertEquals(-1L, timetravellingsalesman.determineCost(N, roads));
  }
  ...
  public void case199() {
    int N = 3;
    String[] roads = { "0,1,2 0,2,2 1,2,1" };
    assertEquals(3L, timetravellingsalesman.determineCost(N, roads));
  }
